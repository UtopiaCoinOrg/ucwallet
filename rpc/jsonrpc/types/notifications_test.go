...
func TestWalletSvrWsNtfns(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "accountbalance",
			newNtfn: func() (interface{}, error) {
				return ucjson.NewCmd("accountbalance", "acct", 1.25, true)
			},
			staticNtfn: func() interface{} {
		...
		},
		{
			name: "ucdconnected",
			newNtfn: func() (interface{}, error) {
				return ucjson.NewCmd("ucdconnected", true)
			},
			staticNtfn: func() interface{} {
				return NewUcdConnectedNtfn(true)
			},
			marshalled: `{"jsonrpc":"1.0","method":"ucdconnected","params":[true],"id":null}`,
			unmarshalled: &UcdConnectedNtfn{
				Connected: true,
			},
		},
		{
			name: "newtx",
			newNtfn: func() (interface{}, error) {
				return ucjson.NewCmd("newtx", "acct", `{"account":"acct","address":"1Address","category":"send","amount":1.5,"fee":0.0001,"confirmations":1,"txid":"456","walletconflicts":[],"time":12345678,"timereceived":12345876,"vout":789,"otheraccount":"otheracct"}`)
			},
			staticNtfn: func() interface{} {
		...
		},
		{
			...
			newNtfn: func() (interface{}, error) {
				return ucjson.NewCmd("revocationcreated", "123", "1234")
			},
			staticNtfn: func() interface{} {
		...
		},
		{
			name: "ticketpurchase",
			newNtfn: func() (interface{}, error) {
				return ucjson.NewCmd("ticketpurchased", "123", 5)
			},
			staticNtfn: func() interface{} {
		...
		},
		{
			name: "votecreated",
			newNtfn: func() (interface{}, error) {
				return ucjson.NewCmd("votecreated", "123", "1234", 100, "12345", 1)
			},
			staticNtfn: func() interface{} {
		...
		},
		{
			...
			newNtfn: func() (interface{}, error) {
				return ucjson.NewCmd("walletlockstate", true)
			},
			staticNtfn: func() interface{} {
	...
	for i, test := range tests {
		...
		if err != nil {
			t.Errorf("ucjson.MarshalCmd #%d (%s) unexpected error: %v", i,
				test.name, err)
			continue
		}
		...
		if err != nil {
			t.Errorf("ucjson.ucjson.UnmarshalCmd #%d (%s) unexpected error: %v", i,
				test.name, err)
			continue
		}
