...
// NewAmountFlag creates an AmountFlag with a default ucutil.Amount.
func NewAmountFlag(defaultValue ucutil.Amount) *AmountFlag {
...
func (a *AmountFlag) UnmarshalFlag(value string) error {
	value = strings.TrimSuffix(value, " UC")
	valueF64, err := strconv.ParseFloat(value, 64)
	if err != nil {
		return err
	}
	amount, err := ucutil.NewAmount(valueF64)
	if err != nil {
		return err
	}
	a.Amount = amount
