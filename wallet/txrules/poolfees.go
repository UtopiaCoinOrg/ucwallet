...
func StakePoolTicketFee(stakeDiff ucutil.Amount, relayFee ucutil.Amount,
	height int32, poolFee float64, params *chaincfg.Params) ucutil.Amount {
	...
	return ucutil.Amount(num.Int64())
}
