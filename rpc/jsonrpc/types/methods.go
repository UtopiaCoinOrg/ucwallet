...
func NewLockUnspentCmd(unlock bool, transactions []ucdtypes.TransactionInput) *LockUnspentCmd {
...
// the SignRawTransactionCmd struct.  Contains Utopia additions.
...
func init() {
	...
	for i := range register {
		ucjson.MustRegister(register[i].method, register[i].cmd, ucjsonv2WalletOnly)
		ucjson.MustRegister(Method(register[i].method), register[i].cmd, 0)
	}

	// ucd methods also implemented by ucwallet
	register = []registeredMethod{
		{"authenticate", (*ucdtypes.AuthenticateCmd)(nil)},
		{"getbestblock", (*ucdtypes.GetBestBlockCmd)(nil)},
		{"getbestblockhash", (*ucdtypes.GetBestBlockHashCmd)(nil)},
		{"getblockcount", (*ucdtypes.GetBlockCountCmd)(nil)},
		{"getblockhash", (*ucdtypes.GetBlockHashCmd)(nil)},
		{"getinfo", (*ucdtypes.GetInfoCmd)(nil)},
		{"help", (*ucdtypes.HelpCmd)(nil)},
		{"ticketsforaddress", (*ucdtypes.TicketsForAddressCmd)(nil)},
		{"validateaddress", (*ucdtypes.ValidateAddressCmd)(nil)},
		{"verifymessage", (*ucdtypes.VerifyMessageCmd)(nil)},
		{"version", (*ucdtypes.VersionCmd)(nil)},
	}
	for i := range register {
		ucjson.MustRegister(Method(register[i].method), register[i].cmd, 0)
	}
