...
func TestWalletSvrWsCmds(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd("createencryptedwallet", "pass")
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd("exportwatchingwallet")
			},
			staticCmd: func() interface{} {
			...
			unmarshalled: &ExportWatchingWalletCmd{
				Account:  nil,
				Download: ucjson.Bool(false),
			},
		},
		{
			name: "exportwatchingwallet optional1",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd("exportwatchingwallet", "acct")
			},
			staticCmd: func() interface{} {
				return NewExportWatchingWalletCmd(ucjson.String("acct"), nil)
			},
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd("exportwatchingwallet", "acct", true)
			},
			staticCmd: func() interface{} {
				return NewExportWatchingWalletCmd(ucjson.String("acct"),
					ucjson.Bool(true))
			},
			marshalled: `{"jsonrpc":"1.0","method":"exportwatchingwallet","params":["acct",true],"id":1}`,
			unmarshalled: &ExportWatchingWalletCmd{
				Account:  ucjson.String("acct"),
				Download: ucjson.Bool(true),
			},
		},
		{
			name: "getunconfirmedbalance",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd("getunconfirmedbalance")
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd("getunconfirmedbalance", "acct")
			},
			staticCmd: func() interface{} {
				return NewGetUnconfirmedBalanceCmd(ucjson.String("acct"))
			},
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd("listaddresstransactions", `["1Address"]`)
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd("listaddresstransactions", `["1Address"]`, "acct")
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd("listalltransactions")
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd("listalltransactions", "acct")
			},
			staticCmd: func() interface{} {
				return NewListAllTransactionsCmd(ucjson.String("acct"))
			},
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd("recoveraddresses", "acct", 10)
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "walletislocked",
			newCmd: func() (interface{}, error) {
				return ucjson.NewCmd("walletislocked")
			},
			staticCmd: func() interface{} {
