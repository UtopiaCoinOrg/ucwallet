...
type InputSource func(target ucutil.Amount) (detail *InputDetail, err error)
...
func NewUnsignedTransaction(outputs []*wire.TxOut, relayFeePerKb ucutil.Amount,
