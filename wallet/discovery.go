...
import (
	...
	hd "github.com/UtopiaCoinOrg/ucd/hdkeychain"
...
// exists address index of a trusted ucd RPC server.
type existsAddrIndexFinder struct {
	wallet *Wallet
	client *rpc.Client
}

func (f *existsAddrIndexFinder) addressesUsed(addrs []ucutil.Address) (bitset.Bytes, error) {
	const op errors.Op = "ucd.jsonrpc.existsaddresses"
