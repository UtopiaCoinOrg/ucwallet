...
var helpDescsEnUS = map[string]string{
	...
	"inforesult-relayfee":        "The minimum relay fee for non-free transactions in UC/KB",
	...
	"getreceivedbyaccount--result0":  "The total received amount valued in utopia",
	...
	"getreceivedbyaddress--result0":  "The total received amount valued in utopia",
	...
	"gettransactionresult-amount":          "The total amount this transaction credits to the wallet, valued in utopia",
	...
	"listaccounts--result0--desc":  "JSON object with account names as keys and utopia amounts as values",
	"listaccounts--result0--key":   "The account name",
	"listaccounts--result0--value": "The account balance valued in utopia",
	...
	"listreceivedbyaccountresult-amount":        "Total amount received by payment addresses of the account valued in utopia",
	...
	"listreceivedbyaddressresult-amount":            "Total amount received by the payment address valued in utopia",
	...
	"listtransactionsresult-amount":            "The value of the transaction output valued in utopia",
	...
	"listunspentresult-amount":        "The amount of the output valued in utopia",
	...
	"sendfrom-amount":      "Amount to send to the payment address valued in utopia",
	...
	"sendmany-amounts--desc":  "JSON object using payment addresses as keys and output amounts valued in utopia to send to each address",
	"sendmany-amounts--key":   "Address to pay",
	"sendmany-amounts--value": "Amount to send to the payment address valued in utopia",
	...
	"sendtoaddress-amount":    "Amount to send to the payment address valued in utopia",
	...
	"sendtomultisig-amount":      "Amount to send to the payment address valued in utopia",
	...
	"setticketmaxprice-max":       "The max price (in uc).",
	...
	"settxfee-amount":    "The new fee per kB of the serialized tx size valued in utopia",
	...
	"getunconfirmedbalance--result0":  "Total amount of all unmined unspent outputs of the account valued in utopia.",
	...
	"getwalletfee--result0":  "Current tx fee (in UC)",
	...
	"purchaseticket-ticketfee":          "The transaction fee rate (UC/kB) to use (overrides fees set by the wallet config or settxfee RPC)",
	...
	"setticketfee-fee":       "The new fee per kB of the serialized tx size valued in utopia",
